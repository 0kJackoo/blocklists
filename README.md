...
|------|------|-----------|---------|-------------|-------------| 
add.2o7Net | [site](https://github.com/FadeMind/hosts.extras/tree/master/add.2o7Net) | [raw]([https://github.com/FadeMind/hosts.extras/blob/master/add.2o7Net/hosts](https://raw.githubusercontent.com/FadeMind/hosts.extras/master/add.2o7Net/hosts)) | MIT | 2o7Net tracking sites based on hostsfile.org content | base
